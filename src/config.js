module.exports = {
    ...
    DATABASE_URL: process.env.DATABASE_URL || 'postgresql://dunder-mifflin:password@localhost/test_setup',
    TEST_DATABASE_URL: process.env.TEST_DATABASE_URL || 'postgresql://dunder-mifflin:password@localhost/test_setup',
