module.exports = {
    ...
    DB_URL: process.env.DB_URL || 'postgresql://dunder_mifflin:password@localhost/test_setup',
    TEST_DB_URL: process.env.TEST_DB_URL || 'postgresql://dunder_mifflin:password@localhost/test_setup',
